	...
	jQuery(document).ready(function($) {
		...
		function initPageBackground() {
			if($('body').hasClass('image-background')) { // IMAGE BACKGROUND
				...
				$("body").backstretch([
					// "http://i.imgur.com/oRGDEvz.jpg" // lighter
					"http://i.imgur.com/YLbro8u.jpg" // darker
				]);
		...
		/*	COUNTDOWN
		/* ------------------------------------------------------------------------ */
		$('#clock').countdown('2015/10/14 12:00:00').on('update.countdown', function(event) {
		...
		$('.mailchimp').ajaxChimp({
			...
			url: "//twitter.us10.list-manage.com/subscribe/post?u=262d2200144ed0f65cc1390e8&amp;id=9dd6191947" //Replace this with your own mailchimp post URL. Don't remove the "". Just paste the url inside "".  
		});
